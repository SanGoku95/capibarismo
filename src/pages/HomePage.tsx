...
import { generateWebsiteStructuredData, generateElectionStructuredData } from '@/lib/seo';
...
export function HomePage() {
    return (
        <>
            <SEO 
                title="Comparador de Candidatos Presidenciales Perú 2026"
                description="Plataforma interactiva para comparar candidatos presidenciales de Perú 2026. Encuentra propuestas, trayectorias y posiciones políticas de forma visual y accesible."
                keywords={[
                    'capybarismo',
            ...
            <StructuredData data={generateElectionStructuredData()} />
            ...
            <div className="min-h-screen fighting-game-bg text-white">
                <main className="container mx-auto px-4 py-8 sm:py-12 md:py-20">
                    ...
                    <nav className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto" aria-label="Herramientas principales">
                        {featureCards.map((feature) => (
                            <Link to={feature.link} key={feature.title} className="block group" aria-label={`Acceder a ${feature.title}: ${feature.description}`}>
