...
export const proyectos: Record<string, ProyectoPolitico> = {
  ...
  antauro: {
    ...
    resumen:
      "Propone una ruptura total con el sistema democrático y económico actual para 'refundar la patria' sobre las bases de una ideología etnonacionalista, que combina un estatismo radical, la reivindicación de la identidad андina y la imposición de una disciplina militar.",
    detalles: [
      {
        subtitulo: "Asamblea Constituyente y Nueva Constitución",
        texto:
          "Su objetivo principal es derogar la Carta Magna de 1993 y redactar una nueva Constitución que reconozca a la 'raza cobriza' como eje identitario y declare al Estado soberano sobre los recursos estratégicos.",
        fuente: "https://www.youtube.com/watch?v=33h_pekXTxs",
      },
      {
        subtitulo: "Pena de Muerte por 'Traición a la Patria'",
        texto:
          "Propone aplicar la pena capital por fusilamiento a expresidentes y altos funcionarios que considere corruptos y 'traidores a la patria', manifestando su intención de desconocer los tratados internacionales que lo impidan.",
        fuente: "https://www.youtube.com/watch?v=ox4vL808Ba4",
      },
      {
        subtitulo: "Modelo Económico: Soberanía y Nacionalización",
        texto:
          "Plantea la nacionalización y expropiación de los sectores estratégicos como la minería y los hidrocarburos, y la creación de un 'gran Estado proteccionista' inspirado en el gobierno militar de Juan Velasco Alvarado.",
        fuente: "https://www.youtube.com/watch?v=bOxifrWM1h0",
      },
    ],
  },
  "martin-vizcarra": {
    titulo: "Reforma Institucional y Descentralización",
    resumen:
      "Su proyecto se define por la continuidad de su agenda presidencial, centrada en las reformas para la lucha contra la corrupción y el fortalecimiento institucional, junto con una apuesta por la descentralización y la ejecución de obras de infraestructura.",
    detalles: [
      {
        subtitulo: "Lucha Anticorrupción y Reforma Institucional",
        texto:
          "Su principal bandera es la reforma política y judicial, impulsando la creación de la Junta Nacional de Justicia (JNJ) y un referéndum para la no reelección de congresistas. Ante el bloqueo parlamentario, disolvió el Congreso en 2019.",
        fuente:
      ...
      },
      {
        ...
        texto:
          "Aplicó un enfoque pragmático en la gestión de conflictos mineros, como la suspensión de la licencia de construcción de Tía María en 2019 hasta no haber condiciones sociales, mientras que en Moquegua promovió el diálogo y acuerdos con Anglo American (Quellaveco).",
        fuente:
      ...
      {
        subtitulo: "Seguridad ciudadana: Expulsión de delincuentes extranjeros",
        texto:
          "Propone la expulsión inmediata de ciudadanos extranjeros que cometan delitos, afirmando que es una política que ya se aplicaba durante su gobierno.",
  ...
  "guillermo-bermejo": {
    ...
    resumen:
      "Su proyecto político busca una refundación total del Estado sobre bases socialistas, a través de una nueva Constitución que permita un rol protagónico del Estado en la economía, la industrialización de los recursos y la reivindicación de los sectores populares.",
    detalles: [
      {
        subtitulo: "Asamblea Constituyente y Nueva Constitución",
        texto:
          "Considera la Constitución de 1993 como el pilar de un sistema neoliberal ilegítimo, por lo que su principal propuesta es la convocatoria a una Asamblea Constituyente para redactar una nueva Carta Magna con amplia participación ciudadana.",
        fuente: "https://www.youtube.com/watch?v=idwJ4xaDfZE",
      },
      {
        subtitulo: "Modelo Económico: Industrialización y Rol Protagónico del Estado",
        texto:
          "Defiende la industrialización de los recursos naturales para generar valor agregado y aboga por un papel más protagónico del Estado en la economía, proponiendo una reforma constitucional para eliminar el principio de subsidiariedad estatal.",
        fuente: "https://www.youtube.com/watch?v=PMm960A6ZHA",
      },
      {
        subtitulo: "Propuestas Sociales y Legislativas",
        texto:
          "Apoya una 'segunda reforma agraria' y la atención a la crisis alimentaria. Como legislador, ha presentado proyectos de ley para aumentar penas por contaminación ambiental y establecer asignaciones económicas para licenciados de las Fuerzas Armadas y rondas campesinas.",
        fuente: "https://www.youtube.com/watch?v=ZXLshiRnFmM",
      },
    ],
  },
  "carlos-alvarez": {
