...
export const trayectorias: Record<string, TrayectoriaEstructurada> = {
  ...
  belmont: {
    ...
    educacion: {
      formacion: "Próximamente",
      instituciones: "Próximamente",
      credencial_hito: "Próximamente",
      enfoque: "Próximamente",
    },
    sector_privado: {
      actividad: "Próximamente",
      escala_impacto: "Próximamente",
      estrategia_ambito: "Próximamente",
    },
    sector_publico: {
      cargos_roles: "Próximamente",
      periodo: "Próximamente",
      logros_controversias: "Próximamente",
      territorio_ambito: "Próximamente",
    },
    politica: {
      rol_accion: "Próximamente",
      competicion: "Próximamente",
      resultados_posicionamiento: "Próximamente",
      linea: "Próximamente",
    },
    resumen_corto: "Próximamente",
  },
  cerron: {
    id: "cerron",
