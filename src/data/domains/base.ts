...
export const base: Record<string, CandidateBase> = {
  ...
  belmont: {
    ...
    headshot: '/fotos_candidatos/belmont/belmont_poster_h480_q80.webp',
  ...
  cerron: {
    ...
    ideologia: 'Próximamente',
    headshot: '/fotos_candidatos/cerron/vladimir cerron_poster_h480_q80.webp',
  ...
  guevara: {
    ...
    ideologia: 'Próximamente',
    headshot: '/fotos_candidatos/guevara/mesiasguevara_poster_h480_q80.webp',
  ...
  olivera: {
    ...
    ideologia: 'Próximamente',
    headshot: '/fotos_candidatos/olivera/olivera_poster_h480_q80.webp',
  ...
  sanchez: {
    ...
    ideologia: 'Próximamente',
    headshot: '/fotos_candidatos/sanchez/roberto-sanchez_poster_h480_q80.webp',
